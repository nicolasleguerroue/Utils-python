...
class House(Debug):
    ...
    def __init__(self, battery=None, panels=None, sunCalendar=None, saltPlant=None):
    ...
    def check(self):
        ...
        if(self.__annualEnergy == 0):
            error +=1
            self.println("Veuillez ajouter la consommation annuelle en kWh en utilisant la methode 'setAnnualEnergy'", Debug.ERROR)
