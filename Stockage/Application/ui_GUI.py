...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_8.addWidget(self.pb_progressBar, 1, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.pb_run, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_nextStorage, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.graph_battery, 1, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.graph_salt, 2, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.graph_hydrogen, 3, 0, 1, 2)
        ...
        self.pb_previousBilan = QPushButton(self.tab)
        self.pb_previousBilan.setObjectName(u"pb_previousBilan")

        self.gridLayout_5.addWidget(self.pb_previousBilan, 0, 0, 1, 1)

        self.pb_nextBilan = QPushButton(self.tab)
        self.pb_nextBilan.setObjectName(u"pb_nextBilan")

        self.gridLayout_5.addWidget(self.pb_nextBilan, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.graph_panels, 1, 0, 1, 2)
        ...
        self.pb_previousPower = QPushButton(self.tab_3)
        self.pb_previousPower.setObjectName(u"pb_previousPower")

        self.gridLayout_7.addWidget(self.pb_previousPower, 0, 0, 1, 1)

        self.pb_nextPower = QPushButton(self.tab_3)
        self.pb_nextPower.setObjectName(u"pb_nextPower")

        self.gridLayout_7.addWidget(self.pb_nextPower, 0, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.graph_bilan, 1, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_run.setText(QCoreApplication.translate("MainWindow", u"Lancer la simulation", None))
